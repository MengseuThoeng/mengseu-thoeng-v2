...
export function HeroClean() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="min-h-screen relative overflow-hidden bg-white dark:bg-black flex items-center justify-center transition-colors"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-xl text-gray-700 dark:text-gray-400 max-w-xl mb-8">
                Software Engineer & Microservices Architect specializing in scalable systems,
                event-driven architecture, and modern web applications.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Link href="#contact">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 border border-gray-400 dark:border-gray-700 rounded-full text-gray-900 dark:text-white font-semibold hover:bg-gray-200 dark:hover:bg-white/5 transition-colors"
                  >
                    Get In Touch
                  </motion.button>
                </Link>
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-300 dark:border-gray-800"
            >
              <div>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">3+</div>
                <div className="text-sm text-gray-600 dark:text-gray-500">Years Experience</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">86+</div>
                <div className="text-sm text-gray-600 dark:text-gray-500">Projects</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">15+</div>
                <div className="text-sm text-gray-600 dark:text-gray-500">Technologies</div>
              </div>
            </motion.div>
          </div>
      ...
      >
        <motion.div
          ...
          className="flex flex-col items-center gap-2 text-gray-600 dark:text-gray-500"
        >
          <span className="text-sm">Scroll to explore</span>
          <div className="w-6 h-10 border-2 border-gray-400 dark:border-gray-700 rounded-full p-1">
            <motion.div
              animate={{ y: [0, 12, 0] }}
              transition={{ duration: 1.5, repeat: Infinity }}
              className="w-1.5 h-3 bg-gray-600 dark:bg-gray-500 rounded-full mx-auto"
            />
          </div>
        </motion.div>
      </motion.div>
